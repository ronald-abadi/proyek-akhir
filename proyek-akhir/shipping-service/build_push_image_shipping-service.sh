...
# File: build_push_image_shipping-service.sh
...
echo "---------------------------"
docker images > docker-images-shipping-service-awal.txt
echo "Lihat file docker-images-shipping-service-awal.txt untuk melihat daftar image di lokal"
docker images
echo -e "\n"
...
echo "----------------------------------------"
docker tag shipping-service:latest ronaldabadi/shipping-service:latest
echo -e "\n"
...
echo "--------------------------"
docker push ronaldabadi/shipping-service:latest
echo -e "\n"
...
echo "---------------------------------------------"
export ITEM_APP_IMAGE_ID="$(docker images -q shipping-service:latest)"
docker tag $ITEM_APP_IMAGE_ID ghcr.io/ronald-abadi/shipping-service:latest
echo -e "\n"
...
echo "-------------------------------"
docker push ghcr.io/ronald-abadi/shipping-service:latest
echo -e "\n"
...
echo "---------------------------------------"
docker images > docker-images-shipping-service-akhir.txt
echo "Lihat file docker-images-shipping-service-akhir.txt untuk melihat daftar image di lokal"
docker images
echo "DONE..."
